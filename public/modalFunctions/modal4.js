function Pop() {
    ...
    let createPopUp = function () {
      ...
      if (!document.getElementById('modal1popup')) {
        ...
        mainDiv.innerHTML += `  <div className="flex flex-col items-center bg-white max-w-2xl min-w-[300px] py-10">
        <div
          className="rounded-full w-[90px] h-[90px] flex items-center justify-center bg-[${content.color}]"
        >
          <svg
        ...
        <div class="inline-flex flex-col items-center justify-center px-[65px] py-10 w-full">
          <span class="font-bold text-[30px]">${content.area.header}</span>
          <span class="mt-5 text-xl text-center">  ${content.area.description.description1}</span>
          <span class="text-base mt-5 text-[#777777] text-center">${content.area.description.description2}</span>
          <button
            id="continueButton"
            type="button"
            id="input1"
            class="text-white w-full py-4 rounded-2xl mt-11 border bg-[${content.color}] text-[${content.textColor}]"
          >
          ...
          id="cancelButton"
            type="button"
            id="input2"
            class="w-full py-4 rounded-2xl border border-[#D2DAE3] mt-3"
          >
         ${content.area.button.button2}
          </button>
        </div>
        <button id="closeButton" type="button" class="absolute top-4 right-4 ">
